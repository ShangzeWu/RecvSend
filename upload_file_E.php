...
&& in_array($extension, $allowedExts))
{
    ...
    else
    {
        ...
        if (file_exists("uploadE/" . $_FILES["file"]["name"]))
        {
        ...
        else
        {
            ...
            move_uploaded_file($_FILES["file"]["tmp_name"], "/var/www/html/RecvSend/uploadE/" . $_FILES["file"]["name"]);
            echo "文件存储在: " . "uploadE/" . $_FILES["file"]["name"];
        }
    }
